...
class StepUpEvalTab(ttk.Frame):
    ...
    def create_form(self):
        ...
        # NEW: Current Shift Information Section
        self.create_shift_info_section()

        # Add attendance section after shift info
        self.create_attendance_section()

        # --- SUPERVISOR EVALUATION SECTION ---
        supervisor_frame = ttk.LabelFrame(self.scrollable_frame, text="🔧 Supervisor Evaluation Tools", padding="15")
        supervisor_frame.grid(row=3, column=0, columnspan=2, padx=5, pady=(10, 15), sticky="ew")
        supervisor_frame.grid_columnconfigure(0, weight=1)

        # Section description
        description_text = (
            "Use this section to record competency evaluations and assign maintenance tasks to employees.\n"
            "Complete all fields when documenting successful competency demonstrations or skill assessments."
        )
        description_label = ttk.Label(supervisor_frame, text=description_text,
                                      font=('TkDefaultFont', 9), foreground='#555555',
                                      wraplength=700, justify='left')
        description_label.grid(row=0, column=0, columnspan=2, sticky="ew", pady=(0, 20))
        ...
        level_desc = ttk.Label(level_frame,
        ...
        level_desc.grid(row=1, column=0, sticky="w", pady=(2, 8))
        ...
        assign_btn = ttk.Button(level_controls_frame, text="Assign All Tasks For This Level",
                                command=self.assign_all_level_tasks)
        assign_btn.grid(row=0, column=1, padx=(15, 0), sticky="w")
        ...
        status_desc = ttk.Label(status_frame,
        ...
        status_desc.grid(row=1, column=0, sticky="w", pady=(2, 8))
        ...
        assessor_desc = ttk.Label(assessor_frame,
                                  text="Select the supervisor or qualified person who conducted the evaluation",
                                  font=('TkDefaultFont', 8), foreground='#666666', wraplength=300)
        assessor_desc.grid(row=1, column=0, sticky="w", pady=(2, 8))

        self.assessor_var = tk.StringVar()
        self.assessor_combo = ttk.Combobox(assessor_frame, textvariable=self.assessor_var,
        ...
        tips_text = (
            "• Use 'Assign All Tasks' to quickly set up all competencies for a level\n"
        ...
        tips_label.grid(row=1, column=0, sticky="w", pady=(5, 0))
    ...
    def create_shift_info_section(self):
        """Create a dedicated shift information section"""
        ...
        # Schedule details in a text widget for better display
